...
// #define MQTT_HOST       "ec2-34-227-142-219.compute-1.amazonaws.com" //"broker.hivemq.com"
// #define MQTT_PORT       1883
// #define MQTT_TOPIC      "Emcus/4/5000/ota/command"
// #define MQTT_MESSAGE    "Hello from STM32!"
...
// /* Connect function with retry support and buffered debug messages */
// static int mqtt_lwip_connect(void *context, const char *host, word16 port, int timeout_ms)
// {
//     MqttLwipContext *ctx = (MqttLwipContext *)context;
//     struct sockaddr_in server_addr;
...
//     char dbg_buff[128];   /* Debug buffer */

//     for (int attempt = 1; attempt <= MAX_RETRIES; attempt++)
//     {
//         snprintf(dbg_buff, sizeof(dbg_buff),
...
// 		 rc = MqttClient_WaitMessage(&client, 55000); // Wait up to 5 seconds
