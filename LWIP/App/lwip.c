 ...
 * @return __weak
 */
__weak void netif_status_callback(struct netif *netif)
{
}
...
void User_notification(struct netif *netif)
{
  ...
  if (netif_is_link_up(&gnetif)) // checks whether cable is connected or not
  {
...
/************************************************************************************************************************************
 * @brief  Function will be called ones there is a state(connected to disconnected )
 *         chnage in ethernet connection.
 *         This function will update all the IP dynamically as per the connection.
 * @param  argument: netif-> to get the state (disconnected or connected)
